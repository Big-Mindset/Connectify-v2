...
export default function ChatSettings({childRef}){
    ...
    transition={{duration : 0.09}}
     ref={childRef} className={`absolute  origin-top-right  p-4 rounded-lg bg-gray-1 border border-gray-4 z-40  right-1 top-1`}>
