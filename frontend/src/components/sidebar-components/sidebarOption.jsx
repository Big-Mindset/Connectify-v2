...
export default function SidebarOptions({image : paramImage , name,icon}) {
    return <div className="relative group">

        <button className="p-2.5 text-white  rounded-lg cursor-pointer hover:bg-indigo-600/60 duration-200  hover:ring ease-in  focus:bg-indigo-700/90  ring-indigo-600">
        ...
        <div
            className={`
                                  ...
                                  bg-indigo-600/20 px-3 py-1 rounded-lg
                                  ...
                                  before:border-r-4 before:border-r-blue-600
  `}
        >
            {name}
        </div>
